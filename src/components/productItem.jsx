    ...
    <div className="modal-dialog" style={{ minWidth: '100%' }} role="document">
        <div className="modal-content">
            ...
            <div className="modal-body pt-0">
                ...
                <img className="card-img-top" height="250" src={image || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-Sgaglb-AfOqGPKS8iW0qSUk99iflqqneNw&usqp=CAU"} alt="img"/>
            </div>
